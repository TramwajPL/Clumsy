...
namespace Clumsy
{
        ...
        m_Shake(GL_FALSE)
    {
        ...
        glGenTextures(1, &m_TextureDepth.ID);
        glBindTexture(GL_TEXTURE_2D, m_TextureDepth.ID);
        ...
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, m_TextureDepth.ID, 0);
