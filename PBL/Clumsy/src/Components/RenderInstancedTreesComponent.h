...
namespace Clumsy {
	...
	class RenderInstancedTreesComponent : public EntityComponent
	{
	public:
		RenderInstancedTreesComponent(Model* model, std::vector<Transform> transform) : m_Model(model), m_Transform(transform)
		{
